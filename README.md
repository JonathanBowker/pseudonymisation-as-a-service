...
# What is profiling?
GDPR refers to Profiling as a means  
> _“any form of automated processing of personal data consisting of the use of personal data to evaluate certain personal aspects relating to a natural person”_.
...
Pseudonymised data is suitable for a great range of analytical activities, research projects and for statistical purposes. Because less personal data is exposed, pseudonomysation decreases the risk of abuse of exposed data in the case of a data breach. The GDPR sets more relaxed standards for data that is pseudonymised as compared to plain text personal data, and is motivating the adoption of pseudonymisation as a method for securing personal data  processed or held under custodianhsip. When data is "strongly pseudonymised" it is less likely to “significantly affect” data subjects or produce “legal effects” data subjects, because the data subject has less exposure to teh risk of reidentification.
