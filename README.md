...
Beyond the context of a specified use case, the individuals associated with personal data can be identified but only through internally protected procedures and controls governed by controlling data custodian. Within pseudonymised data structures, plain text personal data points still exists but only within physically and logically separated storage joined by securely controlled linking functions that require external information to facilate  operations.
